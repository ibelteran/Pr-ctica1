...
public class CuentaDebito extends Cuenta {
    ...
    public CuentaDebito(String numeroCuenta, double saldo, LocalDate fechaEmision,
        ...
        if (saldo < 0) {
            throw new IllegalArgumentException("La cuenta de debito no puede tener saldo negativo.");
        }
    }

    public void depositar(double monto) {
        if (cuentaVencida()) {
            System.out.println("Transaccion bloqueada: la cuenta de debito esta vencida.");
            return;
        }
    ...
    public void realizarPago(double monto) {
        ...
        if (getSaldo() - monto < 0) {
            System.out.println("Pago rechazado: la cuenta de debito no puede quedar en saldo negativo.");
            return;
        }
